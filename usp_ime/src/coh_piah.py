...
# DESCRIÇÃO  : programa utilizado para verificar se o texto eh um plagio ou naoß
...
#
# funcoes utilizadas para calcular os tracos linguisticos
#

# funcao tamanho_medio_palavra()
def tamanho_medio_palavra():

# funcao relacao_type_token()
#def relacao_type_token():

# funcao razao_hapax_legomana()
#def razao_hapax_legomana():

# funcao tamanho_medio_sentenca()
#def tamanho_medio_sentenca():

# funcao complexidade_sentenca()
#def complexidade_sentenca():

# funcao tamanho_medio_frase()
#def tamanho_medio_frase(): 

#
# funcao main()
#

# texto e valores utilizados para testar as funcoes
# de traco linguistico.
#
# tamanho_medio_palavra = 5.571428571428571
# relacao_type_token = 0.8253968253968254
# razao_hapax_legomana = 0.6984126984126984
# tamanho_medio_sentenca = 210.0
# complexidade_sentenca = 4.5
# tamanho_medio_frase = 45.888888888888886
...
# chamada da funcao para calcular o tamanho medio
# das palavras
